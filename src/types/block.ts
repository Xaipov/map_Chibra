...
export type BlockRawData = {
  ...
  /**
   * Если задан — статус «Можно создать блок» является временным и был получен
   * от мода Minecraft. После этой даты значение считается устаревшим.
   * ISO 8601 строка UTC.
   */
  can_create_expires_at?: string | null;
